...
public class MOB_SwipeUpUntilElementIsVisible implements Nlp {
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		try {
			...
			int startPoint = (int) (screenSize.getHeight()*0.8);//Identify beginning point of scroll for X axis
			...
			while (driver.findElements(By.xpath(xpath)).isEmpty()) {
				...
				swipe.addAction(finger.createPointerMove(Duration.ofMillis(200), PointerInput.Origin.viewport(), screenCenter, endPoint));
